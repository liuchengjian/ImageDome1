...
public class PhotoActivity extends AppCompatActivity {
    private static final String TAG = "lchj";
    private List<LocalMedia> selectList = new ArrayList<>();
    private RecyclerView recyclerView;
    private GridImageAdapter adapter;
    private int themeId;
    private int maxSelectNum = 9;
    List<ImgSimple> listImg = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.dadian).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                for (LocalMedia localMedia : selectList) {
                    listImg.add(new ImgSimple(localMedia.getPath()));
                }
                Intent intent = new Intent(PhotoActivity.this, ImageBrowseActivity.class);
                Bundle bundle = new Bundle();
                bundle.putSerializable("data", (Serializable) listImg);//序列化
